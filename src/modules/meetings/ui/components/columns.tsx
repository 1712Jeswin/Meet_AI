...
export const columns: ColumnDef<MeetingGetMany[number]>[] = [
    ...
    cell: ({ row }) => (
      <div className="flex flex-col gap-y-1">
        ...
        <div className="flex items-center gap-x-2">
          ...
          <GeneratedAvatar variant="botttsNeutral" seed={row.original.agent.name} className="siz-4" />
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return(
        <Badge 
        variant="outline" className={cn('capitalize [&>svg]:size-4 text-muted-foreground',
